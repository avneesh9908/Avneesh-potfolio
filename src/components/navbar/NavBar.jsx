      ...
      <nav className=" container m-auto flex items-center justify-between">
        ...
        >
          ...
          >
            ...
            <a
              href="Avikaushik000@gmail.com"
              className="bg-black text-[1rem] text-white px-6 py-2 rounded-lg font-bold hover:text-yellow-300 md:m-5 md:block md:mx-auto md:w-fit lg:px-2"
            >
              HIRE ME
            </a>
          </ul>
